				...
				<div class="container">
					<div class="site-copyright">
						<?php if(get_theme_mod( 'bacola_copyright' )){ ?>
							<p><?php echo bacola_sanitize_data(str_replace( '[year]', date('Y'), get_theme_mod( 'bacola_copyright' ) )); ?></p>
						<?php } else { ?>
							<p><?php esc_html_e('Copyright 2026.KlbTheme . All rights reserved','bacola'); ?></p>
						<?php } ?>
					</div>
