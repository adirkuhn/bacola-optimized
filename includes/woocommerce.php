...
add_action( 'woocommerce_after_cart', 'bacola_change_cross_sells_columns', 20);
if(!function_exists('bacola_change_cross_sells_columns')){
	function bacola_change_cross_sells_columns() {
		$crosssells = get_theme_mod('bacola_cross_sells_column') ? get_theme_mod('bacola_cross_sells_column') : '4';
...
/*----------------------------
  Upsell Columns
 ----------------------------*/
add_filter( 'woocommerce_upsell_display_args', 'bacola_change_number_related_products', 20 );
if(!function_exists('bacola_change_number_related_products')){
	function bacola_change_number_related_products( $args ) {
		$args['posts_per_page'] = get_theme_mod('bacola_upsell_column');
		$args['columns'] = get_theme_mod('bacola_upsell_column');
		return $args;
	}
}
...
## Product Box SKU 
*************************************************/
function bacola_product_box_sku($product_sku = ''){
	...
	if ( wc_product_sku_enabled() && ( $product->get_sku() || $product->is_type( 'variable' ) ) ){
		echo '<span class="sku_wrapper">'.esc_html__( 'SKU:', 'bacola' ).'<span class="sku">'.esc_html($product->get_sku()).'</span></span>';
	}
}
add_action('bacola_product_box_footer', 'bacola_product_box_sku', 10, 1);

/*************************************************
## Product Attributes
*************************************************/
function bacola_product_attributes($product_sku = '', $productattributes = ''){
...
add_action('bacola_product_box_footer', 'bacola_product_attributes', 10, 2);

/*************************************************
## Wishlist Shortcode
*************************************************/
function bacola_wishlist_shortcode(){
	$output = '';
...
add_action('bacola_wishlist_action', 'bacola_wishlist_shortcode');

/*************************************************
## Compare Shortcode
*************************************************/
function bacola_compare_shortcode(){
	$output = '';
...
add_action('bacola_compare_action', 'bacola_compare_shortcode');
...
/*----------------------------
  Product Type 1
 ----------------------------*/
function bacola_product_type1($product_sku = '', $productattributes = ''){
	global $product;
	global $post;
	global $woocommerce;
	...
	if(bacola_shop_view() == 'list_view' || $postview == 'list_view') {
		...
		$output .= '<div class="thumbnail-wrapper amore5">';
		$output .= bacola_sale_percentage();
		$output .= '<a href="'.get_permalink().'">';
		//$output .= '<img src="'.bacola_product_image().'" alt="'.the_title_attribute( 'echo=0' ).'">';
		$output .= wp_get_attachment_image(
		...
		ob_start();
		do_action('bacola_wishlist_action');
		$output .= ob_get_clean();
		...
		ob_start();
		do_action('bacola_after_shop_loop_item_image');
		$output .= ob_get_clean();
		...
		ob_start();
		do_action('bacola_product_box_footer', $product_sku, $productattributes);
		$output .= ob_get_clean();
...
/*----------------------------
  Product Type 2
 ----------------------------*/
function bacola_product_type2($product_sku = '', $productattributes = ''){
	global $product;
	global $post;
	global $woocommerce;
	...
	if(bacola_shop_view() == 'list_view') {
		...
		$output .= '<div class="row klb-product">';
		$output .= '<div class="col-xl-4 col-lg-4 ">';
		$output .= '<div class="thumbnail-wrapper amore1">';
		$output .= bacola_sale_percentage();
		$output .= '<a href="'.get_permalink().'">';
		//$output .= '<img src="'.bacola_product_image().'" alt="'.the_title_attribute( 'echo=0' ).'">';
		$output .= wp_get_attachment_image(
		...
		$output .= '<div class="thumbnail-wrapper amore6">';
		$output .= bacola_sale_percentage();
		$output .= '<a href="'.get_permalink().'">';
		//$output .= '<img src="'.bacola_product_image().'" alt="'.the_title_attribute( 'echo=0' ).'">';
		$output .= wp_get_attachment_image(
...
function bacola_product_type3(){
	...
	if(bacola_shop_view() == 'list_view') {
		...
		$output .= '<div class="row klb-product">';
		$output .= '<div class="col-xl-4 col-lg-4 ">';
		$output .= '<div class="thumbnail-wrapper amore3">';
		$output .= bacola_sale_percentage();
		$output .= '<a href="'.get_permalink().'">';
		//$output .= '<img src="'.bacola_product_image().'" alt="'.the_title_attribute( 'echo=0' ).'">';
		$output .= wp_get_attachment_image(
		...
		$output .= '<div class="thumbnail-wrapper amore7">';
		$output .= bacola_sale_percentage();
		$output .= '<a href="'.get_permalink().'">';
		//$output .= '<img src="'.bacola_product_image().'" alt="'.the_title_attribute( 'echo=0' ).'">';
		$output .= wp_get_attachment_image(
...
/*----------------------------
  Product Type 4
 ----------------------------*/
function bacola_product_type4($product_sku = '', $productattributes = ''){
	global $product;
	global $post;
	global $woocommerce;
	...
	if(bacola_shop_view() == 'list_view') {
		...
		$output .= '<div class="row klb-product">';
		$output .= '<div class="col-xl-4 col-lg-4 ">';
		$output .= '<div class="thumbnail-wrapper amore4">';
		$output .= bacola_sale_percentage();
		$output .= '<a href="'.get_permalink().'">';
		//$output .= '<img src="'.bacola_product_image().'" alt="'.the_title_attribute( 'echo=0' ).'">';
		$output .= wp_get_attachment_image(
		...
		$output .= '<div class="thumbnail-wrapper amore8">';
		$output .= bacola_sale_percentage();
		$output .= '<a href="'.get_permalink().'">';
		//$output .= '<img src="'.bacola_product_image().'" alt="'.the_title_attribute( 'echo=0' ).'">';
		$output .= wp_get_attachment_image(
...
function bacola_shop_thumbnail () {
	$product_sku = get_theme_mod('bacola_product_box_sku') == 1 || bacola_ft() == 'box_sku' ? 'true' : '';
	$productattributes = get_theme_mod('bacola_product_box_attributes') == 1 || bacola_ft() == 'product_attributes' ? 'true' : '';
	
	if(get_theme_mod('bacola_product_box_type') == 'type4'){
		echo bacola_product_type4($product_sku, $productattributes);
	} elseif (get_theme_mod('bacola_product_box_type') == 'type2'){
		echo bacola_product_type2($product_sku, $productattributes);
	} else {
		echo bacola_product_type1($product_sku, $productattributes);
	}
}
...
function bacola_quick_view_scripts() {
	...
	if(function_exists('bacola_ft')){
  	...
  	wp_enqueue_script( 'bacola-variationform', get_template_directory_uri() . '/assets/js/custom/variationform.js', array('jquery'), '1.0.0', true );
