...
<div class="klb-blog-list blog-wrapper">
	<div class="container">
		...
		<?php } elseif( get_theme_mod( 'bacola_blog_layout' ) == 'grid') { ?>
			<div class="row content-wrapper">
				<div class="col-12 col-md-12 col-lg-9 content-primary">
					<div class="site-posts klb-grid-style grid-<?php echo esc_attr( get_theme_mod( 'bacola_blog_grid_layout_column' ) ); ?>">
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
