...
$thumb_type = get_theme_mod( 'bacola_single_gallery_type' ) == 'vertical' || bacola_ft() == 'vertical' ? 'vertical' : '';
...
<div id="product-<?php the_ID(); ?>" <?php wc_product_class( '', $product ); ?>>
	...
	<div class="product-content">
		<div class="row">
			<div class="col col-12 col-lg-<?php echo esc_attr($image_column); ?> <?php echo esc_attr($thumb_type); ?> product-images">
				<?php
				/**
